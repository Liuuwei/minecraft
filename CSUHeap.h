...
class CSUHeap : public my::DescriptorHeap {
public:
	...
	void createShaderResourceView(const std::string& name, const std::string& filename, D3D12_SHADER_RESOURCE_VIEW_DESC desc);
